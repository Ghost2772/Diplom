...
Ближайшие задачи: проверка и списание остатков при оформлении заказа,
защита от повторного оформления, поиск и фильтры в пользовательском интерфейсе,
подготовка конфигурации публичного сервера и браузерных проверок сценариев.
